...
@pytest.mark.parametrize('testdescr,input_for_custom_warning_function', [
    ('Using optional parameter stacklevel', {'message': DataNotFoundWarning(), 'logger_name': __name__, 'stacklevel': 2}),
    ('Only mandatory parameters', {'message': 'Minimal warning message', 'logger_name': __name__}),
    ('Using all parameters', {'message': 'Warning (all parameters)', 'logger_name': __name__, 'stacklevel': 1, 'category': FutureWarning}),
    ('Using optional parameter category', {'message': 'Warning message', 'logger_name': __name__, 'category': FutureWarning})
])
